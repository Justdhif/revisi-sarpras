    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex space-x-3">
                ...
                <form action="{{ route('items.export.excel') }}" method="GET">
                ...
                <div class="flex items-center justify-center gap-4">
                    ...
                    <div class="w-2/3">
                        <select name="type"
                            ...
                            <option value="consumable" {{ request('type') === 'consumable' ? 'selected' : '' }}>Consumable
                            </option>
                            <option value="non-consumable" {{ request('type') === 'non-consumable' ? 'selected' : '' }}>
                ...
                @if ($items->isEmpty())
                    <div class="flex flex-col items-center justify-center min-h-[70vh] py-12 text-center">
                        <div class="max-w-md mx-auto px-4">
                            ...
                            <p class="text-gray-500 mb-8">Mulai dengan menambahkan barang pertama Anda untuk mengelola
                                inventori.</p>
                            <a href="{{ route('items.create') }}"
