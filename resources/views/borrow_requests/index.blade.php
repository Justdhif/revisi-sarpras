...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-6 bg-white p-4 rounded-lg shadow border border-gray-100">
            <form action="{{ route('borrow-requests.index') }}" method="GET">
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('borrowRequestTable', () => ({
                isLoading: true,
                ...
                submitSearchForm(searchTerm) {
                    ...
                    form.method = 'GET';
                    form.action = '{{ route('borrow-requests.index') }}';
