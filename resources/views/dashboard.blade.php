    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <x-dashboard.stat-card title="Total User" :value="$totalUsers" trend="+2.5%" trendColor="blue"
                    icon='
                ...
                <x-dashboard.stat-card title="Total Barang" :value="$totalItems" trend="+12.1%" trendColor="emerald"
                    icon='
                ...
                <x-dashboard.stat-card title="Peminjaman" :value="$totalBorrows" trend="+5.3%" trendColor="amber"
                    icon='
                ...
                <x-dashboard.stat-card title="Pengembalian" :value="$totalReturns" trend="+8.7%" trendColor="rose"
                    icon='
