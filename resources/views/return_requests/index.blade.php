...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Manajemen Permohonan Pengembalian</h1>
        </div>
        ...
        @if($returns->isEmpty())
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 p-12 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    <h3 class="mt-6 text-xl font-medium text-gray-900">Belum Ada Permohonan Pengembalian</h3>
                    <p class="mt-2 text-gray-500">Tidak ada data permohonan pengembalian barang saat ini.</p>
                </div>
            </div>
        @else
