...
@section('content')
    <div class="container mx-auto px-4 py-8" x-data="returnFilter()" x-init="init()">
        ...
        <div class="mb-6 bg-white p-4 rounded-lg shadow border border-gray-100">
            <div class="flex items-center justify-center gap-4">
                ...
                <div class="relative w-full">
                    ...
                    <input x-model="searchQuery" @input.debounce.500ms="filterReturns()" type="text"
                ...
                <!-- Status Filter -->
                <div class="w-2/3">
                    <select x-model="selectedStatus" @change="filterReturns()"
                ...
                <!-- Date Range Filter -->
                <div class="w-2/3">
                    <input x-model="startDate" @change="filterReturns()" type="date"
                        class="block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        placeholder="Dari Tanggal">
                </div>
                <div class="w-2/3">
                    <input x-model="endDate" @change="filterReturns()" type="date"
                        class="block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div x-show="!isLoading">
            ...
            <!-- Include the returns table partial -->
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('returnFilter', () => ({
                ...
                filterReturns() {
                    ...
                    fetch(`{{ route('return-requests.index') }}?${queryString}`, {
                            headers: {
