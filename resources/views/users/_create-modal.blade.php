    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="w-full max-w-lg rounded-2xl bg-white shadow-xl">
            ...
            <div class="px-8 py-6 border-b border-gray-100 flex items-center justify-between">
                <div>
                    <h3 class="text-2xl font-semibold text-gray-900">Tambah User</h3>
                    <p class="text-sm text-gray-500 mt-1">Lengkapi form berikut untuk menambahkan user baru</p>
                </div>
            ...
            <!-- Form Input -->
            <form action="{{ route('users.store') }}" method="POST" class="px-8 py-6 pt-2 space-y-6">
                @csrf
                <div>
