        ...
        <thead class="bg-gray-50">
            <tr>
                ...
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    Asal</th>
                <th scope="col"
                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Terakhir Login</th>
                <th scope="col"
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex space-x-2 justify-end">
                            <div class="h-7 bg-gray-200 rounded w-20 animate-pulse"></div>
                            <div class="h-7 bg-gray-200 rounded w-20 animate-pulse"></div>
                            <div class="h-7 bg-gray-200 rounded w-20 animate-pulse"></div>
                        </div>
                    </td>
