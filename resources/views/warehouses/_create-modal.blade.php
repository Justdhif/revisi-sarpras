    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="w-full max-w-lg rounded-2xl bg-white shadow-xl">
            ...
            <div class="px-8 py-6 border-b border-gray-100 flex items-center justify-between">
                <div>
                    <h3 class="text-2xl font-semibold text-gray-900">Tambah Gudang</h3>
                    <p class="text-sm text-gray-500 mt-1">Lengkapi form berikut untuk menambahkan gudang baru</p>
                </div>
            ...
            <!-- Form Input -->
            <form action="{{ route('warehouses.store') }}" method="POST" class="px-8 py-6 pt-2 space-y-6">
                @csrf
                <div>
                    <label for="warehouse-name" class="block text-sm font-medium text-gray-700 mb-2">Nama Gudang <span
                ...
                <div>
                    <label for="warehouse-location" class="block text-sm font-medium text-gray-700 mb-2">Lokasi <span
                            class="text-red-500">*</span></label>
                    <div class="relative">
                        <input type="text" id="warehouse-location" name="location" required
                            class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all duration-200 outline-none placeholder-gray-400 text-gray-700 shadow-sm hover:border-gray-300"
                ...
                <div>
                    <label for="warehouse-capacity" class="block text-sm font-medium text-gray-700 mb-2">Kapasitas <span
                            class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <div>
                    <label for="warehouse-description"
                        class="block text-sm font-medium text-gray-700 mb-2">Deskripsi</label>
                    <div class="relative">
                        <textarea id="warehouse-description" name="description" rows="3"
